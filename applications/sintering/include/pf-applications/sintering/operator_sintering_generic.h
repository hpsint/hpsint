      ...
      for (unsigned int q = 0; q < phi.n_q_points; ++q)
        {
          ...
          const Tensor<1, dim, VectorizedArrayType> *lin_etas_gradient = nullptr;
          ...
          gradient_result[0] =
            mobility.M(lin_c_value, lin_etas_value, n_grains, lin_c_gardient, lin_etas_gradient) * gradient[1] +
            mobility.dM_dc(lin_c_value, lin_etas_value, lin_c_gardient, lin_etas_gradient) * lin_mu_gradient * value[0] +
            mobility.dM_dgrad_c(lin_c_value, lin_c_gardient, lin_mu_gradient) * gradient[0];

          for (unsigned int ig = 0; ig < n_grains; ++ig)
            gradient_result[0] +=
              mobility.dM_detai(lin_c_value, lin_etas_value, n_grains, lin_c_gardient, lin_etas_gradient, ig) *
              ...
              if (this->advection.has_velocity(ig))
                {
                  ...
                  value_result[0] +=
                    velocity_ig * gradient[0] + velocity_derivative_ig * lin_c_gardient;
